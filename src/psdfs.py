...
2) Paired group sparsity (when lifted):
...
def psdfs(
    ...
    # ---------------------------------------------------------------------
    # 1) Signed-deviation lift (optional).
    # ---------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------
    # 2) Multiplicative updates for nonnegative reconstruction with group sparsity.
    #
    # Schematic objective:
    #   min_{W>=0} ||X_lift W - Y||_F^2 + beta * sum_groups ||W_g||_2
    #
